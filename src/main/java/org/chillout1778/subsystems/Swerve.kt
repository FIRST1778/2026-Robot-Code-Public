...
//    }
    ...
    fun followTrajectory(sample: SwerveSample) {
        ...
        val pose = getState().Pose

        val targetSpeeds = sample.getChassisSpeeds()
        ...
        setControl(
            swerveRequest.withSpeeds(targetSpeeds)
    ...
    override fun initSendable(builder: SendableBuilder) {
        ...
        builder.addDoubleProperty("Velocity", { state.ModuleStates[0].speedMetersPerSecond }, {})
